...
public class Buyback_change extends CKM_PDL{

public static void Buyback_change() throws Exception {
		...
		{	
				...
				{	
					...
					driver.findElement(By.name("transactionDataBean.tenderAmtFirst")).sendKeys("400");						 
					test.log(LogStatus.PASS, "Tender Amt is entered as 400");
