...
public class Buyback_diff_no extends CKM_PDL{

public static void Buyback_diff_no () throws Exception {
		...
		for (int row = 2; row <= lastrow; row++) {
			...
			if (SSN.equals(RegSSN)) {
				...
				test.log(LogStatus.INFO, "Buyback started");
				...
				test.log(LogStatus.PASS, "Tender Amt is entered as 150 ");
				
				Thread.sleep(5000);					
				driver.findElement(By.name("transactionDataBean.tenderTypeSecond")).sendKeys("Money Order");
				test.log(LogStatus.PASS, "Tender Type ref is 1234");
				
				driver.findElement(By.name("transactionDataBean.ccmoNbrSecond")).sendKeys("6234");
				test.log(LogStatus.PASS, "Tender Type ref is 6234");
				Thread.sleep(5000);
