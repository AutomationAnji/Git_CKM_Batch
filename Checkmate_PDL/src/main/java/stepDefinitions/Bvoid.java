...
public class Bvoid extends CKM_PDL{
public static void Bvoid () throws Exception {
	...
	for (int row = 2; row <= lastrow; row++) {
		...
		String TenderTypev = TestData.getCellData(sheetName, "TenderTypev", row);
...
if(TenderTypev.equals("Cash"))

				
			{	
					
					
				driver.findElement(By.name("transactionDataBean.disbursementType")).sendKeys(TenderTypev);
				test.log(LogStatus.PASS, "Tender Type is selected as "+TenderTypev);
				
				
										
				}
			
if(TenderTypev.equals("Original Tender"))	
