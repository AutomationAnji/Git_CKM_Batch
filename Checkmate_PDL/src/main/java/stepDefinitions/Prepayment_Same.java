...
public class Prepayment_Same extends CKM_PDL{

public static void Prepayment_Same () throws Exception {
...
if(TenderType.equals("Cash"))			
				...
				test.log(LogStatus.PASS, "Tender Type ref is cash");			
...
if(TenderType.equals("Cashiers Check"))			
				...
				try { 
					...
					test.log(LogStatus.PASS, "PrePayment Completed Successfully ");
